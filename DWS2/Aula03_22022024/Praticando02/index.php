...
<div class="container">
      ...
      <div class="row">
        <form action="destino.php" method="post">
          ...
          <div class="mb-3 row">
            <label for="url_img" class="col-sm-2 col-form-label text-end">URL de uma imagem: </label>
            <div class="col-sm-10">
          ...
          <div class="mb-3 row">
            <label for="plano_fundo" class="col-sm-2 col-form-label text-end">Cor de fundo da página: </label>
            <div class="col-sm-10">
              <input type="color" class="form-control" id="plano_fundo" name="plano_fundo" required>
            </div>
          </div>
          <div class="row">
