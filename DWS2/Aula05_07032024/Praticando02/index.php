...
<body>
    ...
    <div class="container">
        ...
        <div class="row mb-3">
          <label for="n1" class="col-sm-2 col-form-label col-form-label-lg">Inicio:</label>
            <div class="col-sm-2">
                <input type="number" step="0.5" class="form-control form-control-lg" name="n1" id="n1">
            </div>
        </div>
        <div class="row mb-3">
          <label for="n2" class="col-sm-2 col-form-label col-form-label-lg">Final:</label>
            <div class="col-sm-2">
                <input type="number" step="0.5" class="form-control form-control-lg" name="n2" id="n2">
            </div>
        </div>
        <div class="row mb-3">
          <label for="n3" class="col-sm-2 col-form-label col-form-label-lg">Incremento:</label>
            <div class="col-sm-2">
